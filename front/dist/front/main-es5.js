...
var CommonDependenciesRoutingModule = /** @class */ (function () {
    function CommonDependenciesRoutingModule() {
    }
...
var CommonDependenciesModule = /** @class */ (function () {
    function CommonDependenciesModule() {
    }
...
var ExtraAlertComponent = /** @class */ (function () {
    function ExtraAlertComponent() {
    }
    ExtraAlertComponent.prototype.ngOnInit = function () {
    };
    ExtraAlertComponent.prototype.close = function () {
        this.st.show = false;
    };
        ...
        this.navbarOpen
            ?
                Object(_my_modules_stuff__WEBPACK_IMPORTED_MODULE_2__["steps"])([
                    [0, function (_) { return _this.navbarCollapse = 'navbar-collapse collapsing prepare'; }],
                    [20, function (_) { return _this.navbarCollapse = 'navbar-collapse opening prepare'; }],
                    [500, function (_) { return _this.navbarCollapse = 'navbar-collapse opened prepare'; }],
                ])
            :
                Object(_my_modules_stuff__WEBPACK_IMPORTED_MODULE_2__["steps"])([
                    [0, function (_) { return _this.navbarCollapse = 'navbar-collapse opening prepare'; }],
                    [70, function (_) { return _this.navbarCollapse = 'navbar-collapse  prepare'; }],
                ]);
        // this.navbarCollapse = 'navbar-collapse  prepare'
    };
...
var NanoSiteComponent = /** @class */ (function () {
    function NanoSiteComponent() {
    }
    NanoSiteComponent.prototype.ngOnInit = function () {
    };
...
var ShowCodeComponent = /** @class */ (function () {
    ...
    ShowCodeComponent.prototype.ngOnInit = function () {
        this.highlightService.highlightAll();
    };
    ShowCodeComponent.ctorParameters = function () { return [
...
var AboutUsComponent = /** @class */ (function () {
    function AboutUsComponent() {
        ...
        this.shuffledArr = function (arr) { return arr.sort(function () { return Math.random() - 0.5; }); };
    }
    ...
    AboutUsComponent.prototype.arrayRandomizer = function (arr) {
        var firstItem = arr.shift(), allItems = this.shuffledArr(arr);
...
var EngineerComponent = /** @class */ (function () {
    ...
    EngineerComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.highlightService.highlightAll(); }, 100);
    };
    EngineerComponent.prototype.getEngineer = function () {
        var name = this.route.snapshot.paramMap.get('name');
        var engineer = _data_team__WEBPACK_IMPORTED_MODULE_3__["default"].filter(function (engineer) { return engineer.name == name; });
        return engineer[0];
    };
    EngineerComponent.prototype.numToArr = function (num) {
        var arr = [];
        for (var i = 0; i < num; i++) {
            arr.push(i);
        }
    ...
    EngineerComponent.prototype.highlight = function () {
        this.highlightService.highlightAll();
        console.log('click');
    };
    EngineerComponent.ctorParameters = function () { return [
...
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        ...
        this.http = http;
        // test
        this.test = function () { return _this.http.get('https://api.github.com/users').toPromise(); };
        // front
        this.getJson = function (path) { return _this.http.get('./assets' + path).toPromise(); };
        // back
        this.register = function (userData) { return _this.http.post(url + '/api/auth/register', userData, httpOptions).toPromise(); };
        this.login = function (userData) { return _this.http.post(url + '/api/auth/login', userData, httpOptions).toPromise(); };
    }
...
var ValidatorService = /** @class */ (function () {
    ...
    ValidatorService.prototype.test = function () {
        return 'v serv';
    };
    // check email
    ValidatorService.prototype.mailValidator = function () {
        var x = { mailValidator: { msg: "Incorrect email" } };
    ...
    // check items equal
    ValidatorService.prototype.itemsAreEqual = function (itemName, first, second) {
        var x = { itemsAreEqual: { msg: itemName + " are not equal" } };
...
var routes = [
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | modules-js-clan-js-clan-module */ "default~modules-authentication-authentication-module~modules-js-clan-js-clan-module").then(__webpack_require__.bind(null, /*! ./@modules/@js-clan/js-clan.module */ "./src/app/@modules/@js-clan/js-clan.module.ts")).then(function (m) { return m.JsClanModule; }); }
    },
    {
        path: 'common',
    ...
    {
        path: 'auth',
        loadChildren: function () { return Promise.all(/*! import() | modules-authentication-authentication-module */[__webpack_require__.e("default~modules-authentication-authentication-module~modules-js-clan-js-clan-module"), __webpack_require__.e("modules-authentication-authentication-module")]).then(__webpack_require__.bind(null, /*! ./@modules/@authentication/@authentication.module */ "./src/app/@modules/@authentication/@authentication.module.ts")).then(function (mod) { return mod.AuthenticationModule; }); }
    },
    {
        path: 'dev',
        loadChildren: function () { return __webpack_require__.e(/*! import() | modules-developer-guide-developer-guide-module */ "modules-developer-guide-developer-guide-module").then(__webpack_require__.bind(null, /*! ./@modules/@developer-guide/@developer-guide.module */ "./src/app/@modules/@developer-guide/@developer-guide.module.ts")).then(function (mod) { return mod.DeveloperGuideModule; }); }
    },
...
var log = console.log;
var steps = function (lot) {
    lot.map(function (one) { return setTimeout(one[1], one[0]); });
};
//////////////////////////////////////////////////////////////////////////////////////////
//                                    work with URL                                     //
//////////////////////////////////////////////////////////////////////////////////////////
...
var getUrlQueries = function () { return parseQuery(location.search); };
var my_alert = function (title, userMsg, devMsg) {
    _app_state__WEBPACK_IMPORTED_MODULE_0__["default"].alert = { show: true, title: title, userMsg: userMsg, devMsg: devMsg };
};
