...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModulesCommonDependenciesCommonDependenciesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_general_night_sky_night_sky_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./components/general/night-sky/night-sky.component */
    "./src/app/@modules/@common-dependencies/components/general/night-sky/night-sky.component.ts"); // added modules
    // services
    // pages
    // components
  ...
  /***/
  function srcAppModulesCommonDependenciesComponentsGeneralNightSkyNightSkyComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NightSkyComponent", function () {
      return NightSkyComponent;
    });
    /* harmony import */
    ...
    function NightSkyComponent__svg_svg_1__svg_circle_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var NightSkyComponent =
    /*#__PURE__*/
    function () {
      function NightSkyComponent() {
        _classCallCheck(this, NightSkyComponent);

        this.allStars = this.randStar(200);
      }

      _createClass(NightSkyComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "randStar",
        value: function randStar(times) {
          var result = [];
    ...
    NightSkyComponent.ɵfac = function NightSkyComponent_Factory(t) {
      return new (t || NightSkyComponent)();
    };

    NightSkyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: NightSkyComponent,
      selectors: [["app-night-sky"]],
      decls: 13,
      vars: 17,
      consts: [[1, "stars-wrapper"], ["class", "stars", "width", "100%", "height", "100%", "preserveAspectRatio", "none", 4, "ngFor", "ngForOf"], ["width", "100%", "height", "100%", "preserveAspectRatio", "none", 1, "extras"], ["id", "comet-gradient"], ["offset", "0%", "stop-color", "rgba(255,255,255,.8)"], ["offset", "100%", "stop-color", "rgba(255,255,255,0)"], ["transform", "rotate(-135)"], ["fill", "url(#comet-gradient)", 1, "comet", "comet-a"], ["transform", "rotate(20)"], ["fill", "url(#comet-gradient)", 1, "comet", "comet-b"], ["transform", "rotate(300)"], ["fill", "url(#comet-gradient)", 1, "comet", "comet-c"], ["width", "100%", "height", "100%", "preserveAspectRatio", "none", 1, "stars"], ["class", "star", 4, "ngFor", "ngForOf"], [1, "star"]],
      template: function NightSkyComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NightSkyComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppModulesCommonDependenciesPagesEngineerEngineerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EngineerComponent_ngb_tab_26_ng_template_1_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var codeExample_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
