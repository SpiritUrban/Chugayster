...
var FlipCardVideoComponent = /** @class */ (function () {
    ...
    FlipCardVideoComponent.prototype.ngOnInit = function () {
        this.urlSafe = this.sanitizer.bypassSecurityTrustResourceUrl(this.url + this.card.video);
    };
    FlipCardVideoComponent.ctorParameters = function () { return [
...
var CabinetComponent = /** @class */ (function () {
    ...
    CabinetComponent.ctorParameters = function () { return [
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        Object(_my_modules_stuff__WEBPACK_IMPORTED_MODULE_4__["log"])(lessonName_1);
                        // log(state)
                        // 2
                        _a = this.st;
                    ...
                    case 2:
                        error_1 = _b.sent();
                        Object(_my_modules_stuff__WEBPACK_IMPORTED_MODULE_4__["log"])(error_1);
                        return [3 /*break*/, 3];
...
var FreeSoundsComponent = /** @class */ (function () {
    ...
    FreeSoundsComponent.prototype.ngOnInit = function () {
    };
...
var VideoSamplesComponent = /** @class */ (function () {
    ...
    VideoSamplesComponent.prototype.ngOnInit = function () {
    };
...
var TrainingApparatusComponent = /** @class */ (function () {
    function TrainingApparatusComponent(api) {
        this.api = api;
        this.st = _app_state__WEBPACK_IMPORTED_MODULE_4__["default"];
    }
    TrainingApparatusComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this.st;
                        return [4 /*yield*/, this.api.getJson('/js-clan/data/training-apparatus.json')];
                    case 1:
                        _a.cards = _b.sent();
                        console.log(this.st.cards);
                        return [3 /*break*/, 3];
    ...
    TrainingApparatusComponent.prototype.play = function () {
        Object(src_app_my_modules_stuff__WEBPACK_IMPORTED_MODULE_3__["log"])('Play');
    };
    TrainingApparatusComponent.ctorParameters = function () { return [
        { type: _common_dependencies_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
    ]; };
