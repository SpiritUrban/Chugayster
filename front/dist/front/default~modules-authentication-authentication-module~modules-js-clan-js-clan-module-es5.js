...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-authentication-authentication-module~modules-js-clan-js-clan-module"], {
  ...
  function srcAppModulesJsClanJsClanRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/@modules/@js-clan/pages/programmer-tips/programmer-tips.component.ts"); // Pages
  ...
  function srcAppModulesJsClanJsClanModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./pages/programmer-tips/programmer-tips.component */
    "./src/app/@modules/@js-clan/pages/programmer-tips/programmer-tips.component.ts"); // Other modules
    // Components
    // Pages
  ...
  function srcAppModulesJsClanPagesCabinetCabinetComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _common_dependencies_services_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var _common_dependencies_components_general_extra_alert_extra_alert_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _components_general_clan_footer_clan_footer_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../components/general/clan-footer/clan-footer.component */
    "./src/app/@modules/@js-clan/components/general/clan-footer/clan-footer.component.ts");

    function CabinetComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    CabinetComponent.ɵfac = function CabinetComponent_Factory(t) {
      return new (t || CabinetComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_common_dependencies_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]));
    };
    ...
    CabinetComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 3,
      consts: [[1, "container", "lessons-content"], [1, "row"], [1, "col-12"], ["class", "col-12  col-sm-12  col-md-6  col-lg-4  col-xl-3", 4, "ngFor", "ngForOf"], [3, "st"], [1, "col-12", "col-sm-12", "col-md-6", "col-lg-4", "col-xl-3"], [1, "user-info"]],
      ...
      _createClass(MemberService, [{
        ...
        value: function _search() {
          ...
          members = members.filter(function (member) {
            return matches(member, searchTerm, _this2.pipe);
          });
  ...
  function srcAppModulesJsClanServicesApiJsClanServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiJsClanService = function ApiJsClanService(http) {
      ...
      this.voteForLessons = function () {
        return _this3.http.get(back + '/vote-for-lessons').toPromise();
      };
    };
