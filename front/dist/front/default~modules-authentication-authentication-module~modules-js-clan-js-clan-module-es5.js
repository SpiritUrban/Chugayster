...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-authentication-authentication-module~modules-js-clan-js-clan-module"], {
  ...
  function srcAppModulesJsClanComponentsGeneralNavNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 12,
      consts: [[1, "p"], ["href", "https://js-clan.com", 1, "logo"], ["src", "assets/js-clan/img/js-clan.svg", "alt", "js-clan"], [1, "led", 2, "--left", "70%", "--top", "20%"], [1, "led", 2, "--left", "68%", "--top", "37%"], [1, "led", 2, "--left", "67%", "--top", "55%"], [1, "led", 2, "--left", "78%", "--top", "12%"], [1, "led", 2, "--left", "76%", "--top", "41%"], [1, "header-right"], [1, "nav"], [3, "routerLink"], [1, "hamburger"], ["aria-hidden", "true", 1, "mdi", "mdi-menu"]],
  ...
  function srcAppModulesJsClanPagesCabinetCabinetComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _common_dependencies_components_general_extra_alert_extra_alert_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _components_general_clan_footer_clan_footer_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../components/general/clan-footer/clan-footer.component */
    "./src/app/@modules/@js-clan/components/general/clan-footer/clan-footer.component.ts");
    ...
    function CabinetComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CabinetComponent_div_4_span_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CabinetComponent_div_4_span_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CabinetComponent_div_4_button_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CabinetComponent_div_4_span_26_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 23);
    ...
    function CabinetComponent_div_4_span_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 24);
    ...
    function CabinetComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 6);
    ...
    function CabinetComponent_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function () {
      ...
      _createClass(ArComponent, [{
        ...
        value: function run() {
          ...
          setTimeout(function () {
            return _this3.spawn('enemy', 'biotronican_crab-simple');
          }, 30000);
          setTimeout(function () {
            return _this3.spawn('enemy', 'biotronican_crab-simple');
          }, 60000);
          setTimeout(function () {
            return _this3.spawn('enemy', 'buster_drone');
          }, 90000);
          setTimeout(function () {
            return _this3.spawn('enemy', 'biotronican_crab');
          }, 120000); //
        ...
        value: function animateExplosion(position) {
          ...
          this.lightLoop = setInterval(function () {
            ...
            if (scale.x > 25) {
              ...
              clearInterval(_this5.lightLoop);
            }
        ...
        value: function init_VR_Camera() {
          ...
          this.camera.addEventListener('componentchanged', function (evt) {
            ...
            if (evt.detail.name == 'rotation') {
              _this6.rocketPositioning();

              _this6.explosionPsositioning();
            }
          });
        } //
        ...
        value: function init_Listeners() {
          ...
          document.addEventListener('keyup', function (e) {
            ...
            if (e.keyCode == 32) _this7.launch();
            if (e.code == 'KeyR') _this7.spawnRocket();
            if (e.code == 'KeyE') _this7.spawn('enemy', 'buster_drone');
          });
        } //
        ...
        value: function launch() {
          ...
          if (freeRoket.length > 0) {
            ...
            rocket.ownInterval = setInterval(function () {
              return _this8.rocketMove(rocket);
            }, 40);
        ...
        value: function aimMove() {
          ...
          all.forEach(function (x, i) {
            ...
            if (toFar > 100) _this9.toBegin(x); //this.remove(x) //x.parentNode.removeChild(x);
        ...
        value: function rocketMove(rocket) {
          ...
          if (toFar > 60) this.rocketsActivate(rocket, ownPosition); // check every

          var allEnemies = document.querySelectorAll('.enemy');
          allEnemies.forEach(function (en) {
            // distance betwen
            var distance = _this10.distanceBetven3D(x, en); // log('distanceBetven3D: ', distance);


            if (distance < 3) {
              _this10.rocketsActivate(rocket, ownPosition);
        ...
        value: function xz() {
          ...
          window.addEventListener("keydown", function (e) {
            var RockPosDeg = _this11.camPosToRockPosDeg(_this11.camPos); // ???
        ...
        key: "startPosition",
        get: function get() {
          return '-10 0.5 -50'; // return { x: '0', y: '0', z: '-100' }
        } // get camera position
        //
    ...
    ArComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ArComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ArComponent_Template_button_click_2_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ArComponent_Template_button_click_4_listener($event) {
            return ctx.run();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("touchstart", function ArComponent_Template_a_scene_touchstart_37_listener($event) {
    ...
    function () {
      function MemberService(pipe) {
        ...
        this._search$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {
          ...
          _this12._members$.next(result.members);
      ...
      _createClass(MemberService, [{
        ...
        value: function _search() {
          ...
          members = members.filter(function (member) {
            return matches(member, searchTerm, _this13.pipe);
          });
  ...
  function srcAppModulesJsClanServicesApiJsClanServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiJsClanService = function ApiJsClanService(http) {
      ...
      this.voteForLessons = function () {
        return _this14.http.get(back + '/vote-for-lessons').toPromise();
      };
    };
