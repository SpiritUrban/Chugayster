...
let DeveloperGuideRoutingModule = class DeveloperGuideRoutingModule {
};
...
let DeveloperGuideModule = class DeveloperGuideModule {
};
...
let UrlQueriesComponent = class UrlQueriesComponent {
    constructor(route) {
        this.route = route;
    }
    ngOnInit() {
...
UrlQueriesComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
